...
\newcommand{\cdif}{\ensuremath{c_{\rm dif}}}
...
\frac{\ell(\ell+1)}{c_{1} \omega^{2}} y_{3} \\
x \frac{\diff y_{2}}{\diff x} &=
...
y_{2} +
\left\{ V^{-1} \left[ \frac{\ell(\ell+1)}{c_{1} \omega^{2}} - \ell - 1 \right] \right\} y_{3} &= 0 \\
(\ell + 1) y_{3} + y_{4} &= 0
\end{aligned}
\right\} 
...
y_{2} +
\left\{ V^{-1} \left[ \frac{\ell(\ell+1)}{\omega^{2}} - \ell - 1 \right] \right\} y_{3} &= 0 \\
(\ell + 1) y_{3} + y_{4} &= 0 \\
