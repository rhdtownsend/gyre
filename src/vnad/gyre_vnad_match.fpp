! Module   : gyre_vnad_match
! Purpose  : viscous nonadiabatic match conditions
!
! Copyright 2016-2021 Rich Townsend
!
...
module gyre_vnad_match
  ...
  type, extends (c_diff_t) :: vnad_match_t
     private
  ...
  end type vnad_match_t

  ! Interfaces

  interface vnad_match_t
     module procedure vnad_match_t_
  end interface vnad_match_t
...
contains
  ...
  function vnad_match_t_ (cx, pt_a, pt_b, md_p, os_p) result (mt)
  ...
  end function vnad_match_t_

  !****

  subroutine stencil_ (this, pt_a, pt_b)

    class(vnad_match_t), intent(inout) :: this
    type(point_t), intent(in)          :: pt_a
    type(point_t), intent(in)          :: pt_b
  ...
  subroutine build (this, st, E_l, E_r, scl)
    ...
    class(vnad_match_t), intent(in) :: this
