! Module   : gyre_vnad_trans
! Purpose  : viscous nonadiabatic variables transformations
!
...
module gyre_vnad_trans
  ...
  type :: vnad_trans_t
   ...
   contains
     ...
     procedure         :: dH_jcd_
     procedure         :: dH_lagp_
  end type vnad_trans_t
  
  ! Interfaces

  interface vnad_trans_t
     module procedure vnad_trans_t_
  end interface vnad_trans_t
...
contains
  ...
  function vnad_trans_t_ (cx, md_p, os_p) result (tr)
  ...
  end function vnad_trans_t_

  !****

  subroutine stencil (this, pt)

    class(vnad_trans_t), intent(inout) :: this
  ...
  subroutine trans_eqns (this, xA, i, st, from)
    ...
    class(vnad_trans_t), intent(in) :: this
