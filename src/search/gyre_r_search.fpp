...
contains
  ...
  subroutine scan_search_ (bp, omega, omega_min, omega_max, process_mode, nm_p)
    ...
    call find_root_brackets_(bp, omega, omega_min, omega_max, omega_a, omega_b, discrim_a, discrim_b)
...
120      format(3X,A,1X,E24.16)
  ...
  subroutine find_root_brackets_ (bp, omega, omega_min, omega_max, omega_a, omega_b, discrim_a, discrim_b)
...
120    format(2X,A,F10.3,1X,A/)
  ...
  end subroutine find_root_brackets_
