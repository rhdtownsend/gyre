...
module gyre_ad_unno_bound
  ...
  type, extends (bound_t) :: ad_unno_bound_t
     private
  ...
  end type ad_unno_bound_t

  ! Interfaces

  interface ad_unno_bound_t
     module procedure ad_unno_bound_t_
  end interface ad_unno_bound_t

  ! Access specifiers

  private

  public :: ad_unno_bound_t
...
contains
  ...
  end function ad_unno_bound_t_

!****

  function inner_bound_ (this, x_i, omega) result (B_i)

    class(ad_unno_bound_t), intent(in) :: this
