...
module grid_weights_m
  ...
  type, extends (cfunc_t) :: geom_cfunc_t
     real(WP) :: s
     integer  :: n
   contains
     procedure :: eval_c_ => eval_geom_cfunc_
  end type geom_cfunc_t
...
contains
  ...
  function eval_geom_cfunc_ (this, z) result (f_z)

    class(geom_cfunc_t), intent(inout) :: this
