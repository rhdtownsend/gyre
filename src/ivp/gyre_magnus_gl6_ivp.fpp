...
module gyre_magnus_gl6_ivp
  ...
  type, extends (magnus_ivp_t) :: magnus_gl6_ivp_t
     private
  ...
  end type magnus_gl6_ivp_t

  ! Interfaces

  interface magnus_gl6_ivp_t
     module procedure magnus_gl6_ivp_t_
  end interface magnus_gl6_ivp_t

  ! Access specifiers

  private

  public :: magnus_gl6_ivp_t

  ! Procedures

contains

  function magnus_gl6_ivp_t_ (jc) result (iv)

    class(jacobian_t), intent(in) :: jc
    type(magnus_gl6_ivp_t)        :: iv

    ! Construct the magnus_gl6_ivp
  ...
  end function magnus_gl6_ivp_t_

!****

  subroutine eval_dOmega_ (this, omega, x_a, x_b, dOmega)

    class(magnus_gl6_ivp_t), intent(in) :: this
...
end module gyre_magnus_gl6_ivp
