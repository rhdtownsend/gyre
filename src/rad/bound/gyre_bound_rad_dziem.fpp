...
module gyre_bound_rad_dziem
  ...
  interface bound_rad_dziem_t
     module procedure bound_rad_dziem_t_
  end interface bound_rad_dziem_t
...
contains
  ...
  function bound_rad_dziem_t_ (ml, jc, op) result (bd)
  ...
  end function bound_rad_dziem_t_
