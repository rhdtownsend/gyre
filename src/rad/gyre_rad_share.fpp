! Module   : gyre_rad_share
! Purpose  : radial adiabatic shared data
!
...
module gyre_rad_share
  ...
  end type rad_share_t

  ! Interfaces

  interface rad_share_t
     module procedure rad_share_t_
  end interface rad_share_t
...
contains
  ...
  function rad_share_t_ (ml, pt_i, md_p, os_p) result (sh)
  ...
  end function rad_share_t_

  !****

  function omega_c (this, Omega_rot, omega)

    class(rad_share_t), intent(in) :: this
