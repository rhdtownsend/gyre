! Module   : gyre_rad_dziem_jacobian
...
module gyre_rad_dziem_jacobian
  ...
  end type rad_dziem_jacobian_t

  ! Interfaces

  interface rad_dziem_jacobian_t
     module procedure rad_dziem_jacobian_t_
  end interface rad_dziem_jacobian_t

  ! Access specifiers

  private

  public :: rad_dziem_jacobian_t
...
contains
  ...
  end function rad_dziem_jacobian_t_

!****

  subroutine eval_ (this, x, omega, A)

    class(rad_dziem_jacobian_t), intent(in) :: this
    real(WP), intent(in)                    :: x
...
end module gyre_rad_dziem_jacobian
