...
module gyre_step_bound
  ...
  type, extends (r_bound_t) :: step_bound_t
     private
     real(WP) :: x_i
     real(WP) :: x_o
   contains 
  ...
  end type step_bound_t

  ! Interfaces

  interface step_bound_t
     module procedure step_bound_t_
  end interface step_bound_t
...
contains
  ...
  function step_bound_t_ (x_i, x_o) result (bd)

    real(WP), intent(in) :: x_i
    real(WP), intent(in) :: x_o
    type(step_bound_t)    :: bd

    ! Construct the step_bound_t
  ...
  end function step_bound_t_

!****

  function B_i_ (this, omega) result (B_i)

    class(step_bound_t), intent(in) :: this
