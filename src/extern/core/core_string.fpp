...
module core_string
  ...
  interface get
     ...
     module procedure get_set
     module procedure get_unit_set
  end interface get
  ...
  interface put_line
     ...
     module procedure put_line_unit
  end interface put_line

  interface replace
     module procedure replace_auto
     module procedure replace_fixed
     module procedure replace_target
...
!****
  ...
  subroutine get_set (string, set, separator, maxlen, iostat)
  ...
  end subroutine get_set

!****

  subroutine get_unit_set (unit, string, set, separator, maxlen, iostat)
...
!****
  ...
  subroutine put_unit (unit, string, iostat)
...
!****
  ...
  subroutine put_line_unit (unit, string, iostat)
...
!****
  ...
  function replace_auto (string, start, substring) result (new_string)
  ...
  end function replace_auto

!****

  function replace_fixed (string, start, finish, substring) result (new_string)
  ...
  end function replace_fixed

!****

  function replace_target (string, target, substring, every, back) result (new_string)
