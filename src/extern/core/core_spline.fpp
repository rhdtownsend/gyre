...
module core_spline
  ...
  interface spline_t
     ...
     module procedure init_eval_derivs_
     module procedure init_y_func_
...
contains
  ...
  function init_ (x, y, dy_dx) result (sp)
...
!****
  ...
  function init_eval_derivs_ (x, y, deriv_type, dy_dx_a, dy_dx_b) result (sp)
  ...
  end function init_eval_derivs_

!****

  function init_y_func_ (x_a, x_b, y_func, y_tol, deriv_type, relative_tol, dy_dx_a, dy_dx_b) result (sp)
