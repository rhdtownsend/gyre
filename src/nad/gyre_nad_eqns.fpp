...
!****
  ...
  function xA_jcd_ (this, x, omega) result (xA)
    ...
    if (l /= 0) then
       ...
       xA(5,3) = alpha_gr*(-V*c_dif + V*nabla_ad*(1._WP-U))
       xA(5,4) = alpha_gr*(-V*nabla_ad)
       xA(5,5) = V*nabla*(4._WP - kappa_S) - (l_0 - 2._WP)
       xA(5,6) = -V*nabla/c_rad
...
!****
  ...
  function xA_lagp_ (this, x, omega) result (xA)
    ...
    xA(6,2) = x**2*c_eps_ad - lambda*c_rad*(alpha_hf*nabla_ad/nabla - (3._WP + dc_rad)/(c_1*omega_c**2))/V_2
