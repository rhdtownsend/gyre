...
:nml_n:`freq_units` (default :nml_v:`NONE`)
  ...
  - :nml_v:`'ROSSBY_I'` : fraction of Rossby frequency (see eqn. :eq:`e:ross-freq`) at inner boundary
  - :nml_v:`'ROSSBY_O'` : fraction of Rossby frequency (see eqn. :eq:`e:ross-freq`) at outer boundary
